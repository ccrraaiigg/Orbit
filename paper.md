...
![the Orbit user interface in Visual Studio Code](Orbit.png "the Orbit
...
Orbit runs a SqueakJS-hosted webapp inside the Visual Studio Code
Integrated Browser. This webapp presents the windows of a remote
Smalltalk environment—class browsers, workspaces, debuggers,
inspectors—as Web Components in a standard web browser page. The page
is shared with the AI agent via Playwright, meaning the agent can:
